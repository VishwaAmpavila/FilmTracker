...
import 'package:film_tracker/screens/watch_later/watchlater_tvshow_screen.dart';
import 'package:flutter/material.dart';

class WatchLaterToggle extends StatelessWidget {
 @override
            ...
            children: [
              ...
              IconButton(
                ...
                onPressed: () {
                 ...
                 Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => WatchLaterTVShowScreen()),
                 );
                },
                color: Colors.white,
              ),
